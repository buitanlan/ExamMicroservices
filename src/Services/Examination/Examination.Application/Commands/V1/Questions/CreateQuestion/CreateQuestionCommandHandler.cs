    ...
    : IRequestHandler<CreateQuestionCommand, ApiResult<QuestionDto>>
{
    public async Task<ApiResult<QuestionDto>> Handle(CreateQuestionCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            return new ApiErrorResult<QuestionDto>(HttpStatusCode.BadRequest,"Single choice question cannot have multiple correct answers.");
        }
        ...
        return new ApiSuccessResult<QuestionDto>(HttpStatusCode.OK,result);
    }
}
